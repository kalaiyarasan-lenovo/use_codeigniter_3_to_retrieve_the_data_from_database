...
<head>
    ...
    <style>
        ...
        .options label:hover {background:#e0f7e0;border-color:#4CAF50;}
        .options input[type="radio"] {display:none;}
        .options input[type="radio"]:checked+span {background:#4CAF50;color:white;display:block;border-radius:8px;}
        ...
        .view-btn {margin-top:15px;background:#2196F3;}
        ...
        .correct::after {content:" ✔";font-weight:bold;color:#28a745;}
        .wrong {background:#f8d7da !important;border:1px solid #dc3545 !important;color:#721c24 !important;}
        .wrong::after {content:" ✖";font-weight:bold;color:#dc3545;}
    </style>
</head>
<body>

...
<head>
    ...
    <style>
        ...
        .options label { flex: 1 1 calc(50% - 10px); background: #f7f7f7; padding: 12px; border-radius: 8px; cursor: pointer; border: 1px solid #ddd; transition: 0.3s; text-align: center; }
        ...
        document.querySelectorAll(".question-box").forEach(qBox => {
            ...
            if (selected) {
                ...
                if (label.getAttribute("data-correct") === "1") {
                    ...
                    wrong++;
                    optGroup.querySelector("label[data-correct='1']").classList.add("correct");
                }
            }
        });
